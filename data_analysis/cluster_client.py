...
def run_client():
    ...
    if operation == OP_PREPROCESS:
        ...
        try:
            ...
            shutil.rmtree(FET_CACHE_DIR)
        except:
            pass
    elif operation == OP_MIST2VECTOR:
        try:
            print 'rmtree:',M2V_FET_CACHE_DIR
            print 'rmtree:',M2V_VECTOR_CACHE_DIR
            shutil.rmtree(M2V_FET_CACHE_DIR)
            shutil.rmtree(M2V_VECTOR_CACHE_DIR)
        except:
            pass
        ...
        mp_process_file(job_q,result_q,server_ip,num_procs,operation,user_name,db_ip,db_name,ngram)
        try:
            shutil.rmtree(MERGE_FET_FET_CACHE_DIR)
            shutil.rmtree(MERGE_FET_FEATURE_CACHE_DIR)
        except:
            pass
        ...
        try:
            shutil.rmtree(MERGE_TABLE_CACHE_DIR)
        except:
            pass
